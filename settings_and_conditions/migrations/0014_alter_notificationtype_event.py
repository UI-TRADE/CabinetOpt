...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('settings_and_conditions', '0013_notification_notify_alter_notificationtype_event'),
    ]
